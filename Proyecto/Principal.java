...
public class Principal extends JFrame implements ActionListener{
 ...
 public Principal(){
  ...
  txtAMaternoTrabajador.setBounds(25,333,150,25);
  ...
  comboAntiguedad.addItem("7 a mas anios de servicio");
 ...
 public void actionPerformed(ActionEvent e){ 
  ...
  if(e.getSource() == miElCreador){
   JOptionPane.showMessageDialog(null,"Creado por Dominguez,Agustin.");
  }
  if(e.getSource() == miCalculo){
   ...
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad  + " tiene derecho a 6 dias de vacaciones.");
   }else if(Antiguedad.equals("2 a 6 anios de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 14 dias de vacaciones.");
   }else if(Antiguedad.equals("7 a mas anios de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 20 dias de vacaciones.");
    }    
   }else if(Departamento.equals("Departamento de Logistica")){
   if(Antiguedad.equals("1 anio de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 7 dias de vacaciones.");
   }else if(Antiguedad.equals("2 a 6 anios de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 14 dias de vacaciones.");
   }else if(Antiguedad.equals("7 a mas anios de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 22 dias de vacaciones.");
    }    
   }else if(Departamento.equals("Departamento de Gerencia")){
   if(Antiguedad.equals("1 anio de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 10 dias de vacaciones.");
   }else if(Antiguedad.equals("2 a 6 anios de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 20 dias de vacaciones.");
   }else if(Antiguedad.equals("7 a mas anios de servicio")){
   textArea1.setText("El empleado " + nombreTrabajador + " " + AP + " " + AM + " " + "quien labora en " + Departamento + " " + " con " + Antiguedad + " tiene derecho a 30 dias de vacaciones.");
    }    
   }
